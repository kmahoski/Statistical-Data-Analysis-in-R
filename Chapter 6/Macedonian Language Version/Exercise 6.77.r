...
boxplot(viscosities[c(1:40)], viscosities[c(41:80)])
# Овојпат добиваме визуелно потврдување на она што претходно го заклучивме
# за расејувањето од вредностите на варијансите. На графикот се гледа дека
# интеркварталното растојание, како и интервалот на расејување се поголеми
# кај вториот примерок.
