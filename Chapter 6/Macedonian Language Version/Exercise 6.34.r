...
# Во оваа задача, во споредба со задача 6.30 каде се користат 10 bars,
# има дополнителни информации за распределбата - приказот е попрецизен
# (содржи повеќе информација од оној со помалку bars).
