...
# Точките лежат блиску до крива која благо наликува на буквата 'S'.
# Ова е индикатор дека распределбата има искривување. Повеќето вредности
# се под правата, што значи дека искривувањето е позитивно, односно кон лево.
