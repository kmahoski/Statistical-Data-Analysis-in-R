...
5 / 70
# Не, бидејќи само 5 од вкупно 70 имаат преживеано во повеќе од 2000 циклуси.
# Оттука, според дадените податоци заклучуваме дека веројатноста е 5 / 70, што е
# приближно 0.071 = 7.1%,  што може да се каже дека е мала веројатност.
