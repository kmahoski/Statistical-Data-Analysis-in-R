...
# Готовата функција "hist" не ги разделува податоците во истиот број кој е
# зададен преку "breaks", туку наоѓа најблиска погодна вредност.
# "breaks = c(<vrednost1>, <vrednost2>, ...)" како параметар за рачно задавање на
# breakpoints за поголема контрола.
