...
# Има 2 outliers. Се гледа дека:
# min(lengths) = q[0] = 83.4,
# q[1] = 88.6,
# median(lengths) = q[2] = 90.4,
# q[3] = 92.2,
# max(lengths) = q[4] = 100.3.
# За разлика од репрезентацијата со Stem-and-Leaf графикот,
# се добива подобра претстава за квантилите и се гледаат outlier-ите.
# И од Stem-and-Leaf графикот може да се процени релативно лесно каде
# се наоѓа средната вредност, се гледаат максимумот и минимумот,
# но не се експлицитно прикажани како кај Box Plot-от.
